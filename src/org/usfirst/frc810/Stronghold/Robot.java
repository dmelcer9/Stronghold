...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        autoDefenseChooser.addObject("Go over defense", new DriveStraight(1,2.5));
    ...
    public void disabledInit(){
    	RobotMap.pusherCompressor1.setClosedLoopControl(false);
    	RobotMap.pusherPiston.set(Value.kOff);
